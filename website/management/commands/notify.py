...
from website.models import TwilioManager, EmailManager


class Command(BaseCommand):
    can_import_settings = True
    option_list = BaseCommand.option_list + (
        make_option('--sms', action="store_true", dest="sms",
                    help="Sends out SMS notifications"),
        make_option('--email', action="store_true", dest="email",
                    help="Sends out Email notifications"),
