...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        make_option('--year', action="store", type="int", dest="year", help="Year to scrape"),
        make_option('--hour', action="store", type="int", dest="hour", help="Hour to scrape"),
        make_option('--force', action="store_true", dest="force", help="Hour to scrape"),
    )
